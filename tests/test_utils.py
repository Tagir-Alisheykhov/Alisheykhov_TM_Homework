...
invalid_keys_file_json = path.join(
    path.dirname(path.dirname(__file__)), "data_for_tests/" "invalid_keys_in_operation.json"
)
invalid_code_currency_json = path.join(
    path.dirname(path.dirname(__file__)), "data_for_tests/" "invalid_code_currency_in_operation.json"
)
invalid_empty_file = path.join(
    path.dirname(path.dirname(__file__)), "data_for_tests/" "invalid_code_currency_in_operation.json"
)
